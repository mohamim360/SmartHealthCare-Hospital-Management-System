...
function PatientMyPrescriptionsPage() {
        ...
        <div className="space-y-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">{total} prescriptions received</p>
                </div>
            </div>
                                    ...
                                    prescriptions.map((p: any) => (
                                        <TableRow key={p.id}>
                                            <TableCell className="font-medium">
                                                <div>
                                                    <p className="text-sm">{p.doctor?.name ?? '—'}</p>
                                                    <p className="text-xs text-muted-foreground">{p.doctor?.designation ?? ''}</p>
                                                </div>
                                            </TableCell>
